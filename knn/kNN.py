...
def classify0(inX, dataSet, labels, k):
    ...
    sortedDistIndicies = sorted(classCount.items(),
...
def datingClassTest():
    hoRatio = 0.10
    datingDataMat, datingLabels = file2matrix('C:/Users/Administrator/Desktop/machine learning/knn/datingTestSet2.txt')
...
def handwritingClassTest(k):
    ...
    for i in range(m):
        ...
        trainingMat[i,:] = img2vector('C:\\Users\\Administrator\\Desktop\\machine learning\\machinelearninginaction\\Ch02\\digits\\trainingDigits\\%s'%fileNameStr)
    testFileList = listdir('C:\\Users\\Administrator\\Desktop\\machine learning\\machinelearninginaction\\Ch02\\digits\\testDigits')
    errorCount = 0.0
